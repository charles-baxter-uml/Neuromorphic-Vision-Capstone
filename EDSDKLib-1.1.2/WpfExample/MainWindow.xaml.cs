...
namespace WpfExample
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void Ws_OnMessage(object sender, MessageEventArgs e)
        {
            ...
            _orientation = new SensorOrientation()
            {
                X = recieved.Values[0],
                Y = recieved.Values[1],
                Z = recieved.Values[2]
            };
            Action updateOrientation = delegate ()
            {
                OrientationTextBlock.Text = _orientation.ToString();
            };

            OrientationTextBlock.Dispatcher.Invoke(System.Windows.Threading.DispatcherPriority.Normal, updateOrientation);     
        }
        ...
        private void MainCamera_DownloadReady(Camera sender, DownloadInfo Info)
        {
            ...
            {
                string dir = null;
                Info.FileName = $"{_orientation.ToString()}.{(Info.IsRAW ? ".CR2" : ".jpg")}";
